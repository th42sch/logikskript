...
\begin{beweis}
  ...
  \begin{description}
    ...
    \item[$(\Leftarrow)$]
      ...
      Mit $(*)$ gilt $\hat V \models x_1 \land \dots \land x_k$,
...
\textsfbf{Theorem~1.31~ (Resolutionssatz, Robinson 1965).} \\
...
% ===================================================================
\section*{T1.17~ Beweis Resolutionssatz für Einheitsresolution}

\textsfbf{Theorem~1.36~ (Resolutionssatz für Einheitsresolution).} \\
...
\pagebreak
% ===================================================================
\section*{T1.18~ Beispiel DPLL-Algorithmus}
...
%% ===================================================================
%\section*{T1.20~ Beispiel 4-Färbbarkeit}
%
...
\textsfbf{Theorem~1.43~ (4-Farben-Satz, allgemeine Graphen).} \\
...
\textsfbf{Theorem~1.40~ (Kompaktheitssatz).} \\
