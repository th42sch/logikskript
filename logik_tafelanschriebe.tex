...
\begin{beweis}
  ...
  \begin{itemize}
    \item
      $\Amf_k$ hat $2k$ Elemente und $R^{\Amf_k} = \emptyset$ für alle 
%      $R \in \tau$.
      Relationssymbole $R$.
    \item
      $\Bmf_k$ hat $2k+1$ Elemente und $R^{\Bmf_k} = \emptyset$ für alle
%      $R \in \tau$.
      Relationssymbole $R$.
  \end{itemize}
  %
...
\begin{beweis}
  ...
  \par\medskip\noindent
  \textsfbf{Schritt 2:~ Schachtelung von {\boldmath $s$} eliminieren}
